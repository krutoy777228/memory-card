...
questions_list.append(Question('Какая планета самая горячая?', 'Венера', 'Сатаурн', 'Меркурий', 'Марс'))
questions_list.append(Question('Как назывался корабль капитана Джека Воробья в "Пиратах Карибского моря"?', 'Черная жемчужина', 'Мародер', 'Чёрный питон', 'Слизерин'))
questions_list.append(Question('На каком языке говорит больше всего людей на Земле?', 'Китайский', 'Английский', 'Арабский', '中国人'))
questions_list.append(Question('Кто нарисовал "Мону лизу"?', 'Леонардо да Винчи', 'Винсент Ван Гог', 'Клод Моне', 'Тарас бульба'))
questions_list.append(Question('Какое животное ассоциируется с Древним Египтом?', 'Кот', 'Ястреб', 'Сурикат', 'Медоед'))
questions_list.append(Question('Сколько глаз у паука?', '8', '1', '2', '13'))
questions_list.append(Question('Как называется крупнейшая технологическая компания Южной Кореи?', 'Samsung', 'Helectrical Unreal Iconic(HU..)', 'Hyundai', 'LG'))
